...
public class CorruptVulcan extends Spell {
	public static final double DAMAGE = 10;
	public static final double BONUS_DAMAGE = 10;
	public static final float STUN_DURATION = 2f;
	public static final int NUM_SHOTS = 15;
	public static final float DURATION = 0.75f;
	public static final double SPEED = 36;
	int shotsFired;
	public CorruptVulcan(Unit owner) {
		super(owner, 0, DURATION, "Corrupt Vulcan", "P|O|W|E|R", "res/spell/corruptvulcan.png", false, true);
	}
	@Override
	...
	public void onThink() {
		...
		ParticleEmitter pe = new ParticleEmitter(Point.add(this.owner.getLoc(), new Point(0, -20)), EmitterTypes.POINT_DIRECTION, "res/particle_genericPurple.png", true, //point/parent, emitter type, image path, alphaDecay
				4.0f, 2.5f, //particle start scale
