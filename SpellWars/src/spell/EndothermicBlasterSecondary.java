...
public class EndothermicBlasterSecondary extends Spell {
	...
	public void onActivate() {
		Projectile p = new Projectile(DAMAGE * this.owner.finalDamageModifier, SPEED, this.owner.direction, this.owner.gridLoc, "res/projectile/icicle.png", this.owner.teamID, true, true, true);
