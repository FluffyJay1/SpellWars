...
public class BouncingOrb extends Spell {
	...
	public static final int NUM_SQUARES = 36;
	//float timer;
	...
	public void onActivate() {
		Projectile projectile = new BouncingOrbProjectile(DAMAGE * this.owner.finalDamageOutputModifier, SPEED, GameMap.getFuturePoint(this.owner.gridLoc, GameMap.getOppositeDirection((char)this.owner.teamID)), this.owner.teamID, NUM_SQUARES);
