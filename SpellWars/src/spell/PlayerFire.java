...
public class PlayerFire extends Spell {
	...
	public void onActivate() {
		Projectile projectile = new Projectile(5, 9, GameMap.clampDirection((char) (GameMap.getOppositeDirection((char)this.owner.teamID))), this.owner.gridLoc, "res/particle_genericWhite.png", this.owner.teamID, true, true, true);
