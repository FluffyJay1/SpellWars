...
public class FireAndBrimstone extends Spell {
	...
	public FireAndBrimstone(Unit owner) {
		super(owner, 0, DURATION, "Fire and Brimstone", "Rain brimstone from the skies, changing enemy panels to lava and setting units on fire", "res/spell/fireandbrimstone.png", false, true);
		this.timer = DURATION;
