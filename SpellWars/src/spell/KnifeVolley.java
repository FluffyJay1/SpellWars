...
public class KnifeVolley extends Spell {
	...
	public void onThink() {
		...
		this.map.addGameElement(new KnifeProjectile(DAMAGE * this.owner.finalDamageOutputModifier, this.owner.direction, Point.add(this.owner.gridLoc, new Point(0, random)), this.owner.teamID));
		this.shotsFired++;
