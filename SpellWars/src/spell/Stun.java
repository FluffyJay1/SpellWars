...
public class Stun extends Spell {
	...
	public void onActivate() {
		StunGrenade snade = new StunGrenade(DAMAGE * this.owner.finalDamageOutputModifier, MAX_STUN_DURATION, MIN_STUN_DURATION, this.owner.direction, this.owner.gridLoc, this.owner.teamID);
