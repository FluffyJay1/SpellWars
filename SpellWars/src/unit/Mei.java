...
public class Mei extends Unit {
	...
	public static final double SPEED_PER_LEVEL = 0.17;
	...
	public static final float STATE2_COOLDOWN = 12;
	public static final float STATE2_CHANCE = 0.4f;
	public static final float STATE2_DURATION = 8;
	public static final float STATE2_PRIMARY_COOLDOWN = 1.2f;
